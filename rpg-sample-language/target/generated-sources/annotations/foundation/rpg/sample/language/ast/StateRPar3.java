...
public class StateRPar3 extends StackState<foundation.rpg.common.symbols.RPar, StackState<foundation.rpg.sample.language.ast.Expression, StackState<foundation.rpg.common.symbols.LPar, ? extends State>>> {

// NoStack:
// Stack:
    public StateRPar3(foundation.rpg.sample.language.ast.AstFactory factory, foundation.rpg.common.symbols.RPar node, StackState<foundation.rpg.sample.language.ast.Expression, StackState<foundation.rpg.common.symbols.LPar, ? extends State>> prev) {
