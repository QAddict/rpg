...
public class StateEqual2 extends StackState<foundation.rpg.common.symbols.Equal, StackState<foundation.rpg.sample.language.ast.Identifier, ? extends State>> {

// NoStack:
// Stack:
    public StateEqual2(foundation.rpg.sample.language.ast.AstFactory factory, foundation.rpg.common.symbols.Equal node, StackState<foundation.rpg.sample.language.ast.Identifier, ? extends State> prev) {
...
// Shift:
    ...
    public State visitExpression(foundation.rpg.sample.language.ast.Expression symbol) {
        return new StateExpression16(getFactory(), symbol, this);
    }
