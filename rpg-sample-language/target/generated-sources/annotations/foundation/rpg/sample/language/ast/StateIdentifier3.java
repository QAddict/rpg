...
public class StateIdentifier3 extends StackState<foundation.rpg.sample.language.ast.Identifier, State> {

// NoStack:
// Stack:
    public StateIdentifier3(foundation.rpg.sample.language.ast.AstFactory factory, foundation.rpg.sample.language.ast.Identifier node, State prev) {
...
// Shift:
    ...
    public State visitLPar(foundation.rpg.common.symbols.LPar symbol) {
        return new StateLPar12(getFactory(), symbol, this);
    }
