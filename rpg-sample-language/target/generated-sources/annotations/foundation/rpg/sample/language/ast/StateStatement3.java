...
// Reduce:
    ...
    public State visitEnd(foundation.rpg.parser.End symbol) throws UnexpectedInputException {
        ...
        return stack6.visitStatement(getFactory().is2(stack5.getNode(), stack4.getNode(), stack3.getNode(), stack2.getNode(), stack1.getNode(), this.getNode())).visitEnd(symbol);
    }
    ...
    public State visitIf(foundation.rpg.common.symbols.If symbol) throws UnexpectedInputException {
		...
		StackState<foundation.rpg.common.symbols.If, ? extends State> stack5 = stack4.getPrev();
		State stack6 = stack5.getPrev();
        return stack6.visitStatement(getFactory().is2(stack5.getNode(), stack4.getNode(), stack3.getNode(), stack2.getNode(), stack1.getNode(), this.getNode())).visitIf(symbol);
    }
    ...
    public State visitIdentifier(foundation.rpg.sample.language.ast.Identifier symbol) throws UnexpectedInputException {
		...
		StackState<foundation.rpg.common.symbols.If, ? extends State> stack5 = stack4.getPrev();
		State stack6 = stack5.getPrev();
        return stack6.visitStatement(getFactory().is2(stack5.getNode(), stack4.getNode(), stack3.getNode(), stack2.getNode(), stack1.getNode(), this.getNode())).visitIdentifier(symbol);
    }
    ...
    public State visitLong(java.lang.Long symbol) throws UnexpectedInputException {
		...
		StackState<foundation.rpg.common.symbols.If, ? extends State> stack5 = stack4.getPrev();
		State stack6 = stack5.getPrev();
        return stack6.visitStatement(getFactory().is2(stack5.getNode(), stack4.getNode(), stack3.getNode(), stack2.getNode(), stack1.getNode(), this.getNode())).visitLong(symbol);
    }
    ...
    public State visitString(java.lang.String symbol) throws UnexpectedInputException {
		...
		StackState<foundation.rpg.common.symbols.If, ? extends State> stack5 = stack4.getPrev();
		State stack6 = stack5.getPrev();
        return stack6.visitStatement(getFactory().is2(stack5.getNode(), stack4.getNode(), stack3.getNode(), stack2.getNode(), stack1.getNode(), this.getNode())).visitString(symbol);
    }
    ...
    public State visitLPar(foundation.rpg.common.symbols.LPar symbol) throws UnexpectedInputException {
		...
		StackState<foundation.rpg.common.symbols.If, ? extends State> stack5 = stack4.getPrev();
		State stack6 = stack5.getPrev();
        return stack6.visitStatement(getFactory().is2(stack5.getNode(), stack4.getNode(), stack3.getNode(), stack2.getNode(), stack1.getNode(), this.getNode())).visitLPar(symbol);
    }
