...
// Reduce:
    ...
    public State visitEnd(foundation.rpg.parser.End symbol) throws UnexpectedInputException {
        ...
        return stack2.visitList1ListOfStatement(foundation.rpg.common.rules.List1.Rules.is(stack1.getNode(), this.getNode())).visitEnd(symbol);
    }
    ...
    public State visitIf(foundation.rpg.common.symbols.If symbol) throws UnexpectedInputException {
        StackState<java.util.List<foundation.rpg.sample.language.ast.Statement>, ? extends State> stack1 = this.getPrev();
		State stack2 = stack1.getPrev();
        return stack2.visitList1ListOfStatement(foundation.rpg.common.rules.List1.Rules.is(stack1.getNode(), this.getNode())).visitIf(symbol);
    }
    ...
    public State visitIdentifier(foundation.rpg.sample.language.ast.Identifier symbol) throws UnexpectedInputException {
        StackState<java.util.List<foundation.rpg.sample.language.ast.Statement>, ? extends State> stack1 = this.getPrev();
		State stack2 = stack1.getPrev();
        return stack2.visitList1ListOfStatement(foundation.rpg.common.rules.List1.Rules.is(stack1.getNode(), this.getNode())).visitIdentifier(symbol);
    }
    ...
    public State visitLong(java.lang.Long symbol) throws UnexpectedInputException {
        StackState<java.util.List<foundation.rpg.sample.language.ast.Statement>, ? extends State> stack1 = this.getPrev();
		State stack2 = stack1.getPrev();
        return stack2.visitList1ListOfStatement(foundation.rpg.common.rules.List1.Rules.is(stack1.getNode(), this.getNode())).visitLong(symbol);
    }
    ...
    public State visitString(java.lang.String symbol) throws UnexpectedInputException {
        StackState<java.util.List<foundation.rpg.sample.language.ast.Statement>, ? extends State> stack1 = this.getPrev();
		State stack2 = stack1.getPrev();
        return stack2.visitList1ListOfStatement(foundation.rpg.common.rules.List1.Rules.is(stack1.getNode(), this.getNode())).visitString(symbol);
    }
    ...
    public State visitLPar(foundation.rpg.common.symbols.LPar symbol) throws UnexpectedInputException {
        StackState<java.util.List<foundation.rpg.sample.language.ast.Statement>, ? extends State> stack1 = this.getPrev();
		State stack2 = stack1.getPrev();
        return stack2.visitList1ListOfStatement(foundation.rpg.common.rules.List1.Rules.is(stack1.getNode(), this.getNode())).visitLPar(symbol);
    }
