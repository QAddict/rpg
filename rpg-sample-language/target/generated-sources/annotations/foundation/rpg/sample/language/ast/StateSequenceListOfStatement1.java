...
public class StateSequenceListOfStatement1 extends StackState<java.util.List<foundation.rpg.sample.language.ast.Statement>, State> {

// NoStack:
// Stack:
    public StateSequenceListOfStatement1(foundation.rpg.sample.language.ast.AstFactory factory, java.util.List<foundation.rpg.sample.language.ast.Statement> node, State prev) {
