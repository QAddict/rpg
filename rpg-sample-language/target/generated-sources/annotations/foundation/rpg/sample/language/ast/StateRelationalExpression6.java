...
public class StateRelationalExpression6 extends StackState<foundation.rpg.sample.language.ast.Expression, State> {

// NoStack:
// Stack:
    public StateRelationalExpression6(foundation.rpg.sample.language.ast.AstFactory factory, foundation.rpg.sample.language.ast.Expression node, State prev) {
...
// Shift:
    ...
    public State visitGt(foundation.rpg.common.symbols.Gt symbol) {
        return new StateGt4(getFactory(), symbol, this);
    }
