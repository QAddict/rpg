...
public class StateMultiplicativeExpression16 extends StackState<foundation.rpg.sample.language.ast.Expression, StackState<foundation.rpg.common.symbols.Plus, StackState<foundation.rpg.sample.language.ast.Expression, ? extends State>>> {

// NoStack:
// Stack:
    public StateMultiplicativeExpression16(foundation.rpg.sample.language.ast.AstFactory factory, foundation.rpg.sample.language.ast.Expression node, StackState<foundation.rpg.common.symbols.Plus, StackState<foundation.rpg.sample.language.ast.Expression, ? extends State>> prev) {
...
// Shift:
    ...
    public State visitTimes(foundation.rpg.common.symbols.Times symbol) {
        return new StateTimes3(getFactory(), symbol, this);
    }
