...
public class StateRPar2 extends StackState<foundation.rpg.common.symbols.RPar, StackState<foundation.rpg.sample.language.ast.Expression, StackState<foundation.rpg.common.symbols.LPar, ? extends State>>> {

// NoStack:
// Stack:
    public StateRPar2(foundation.rpg.sample.language.ast.AstFactory factory, foundation.rpg.common.symbols.RPar node, StackState<foundation.rpg.sample.language.ast.Expression, StackState<foundation.rpg.common.symbols.LPar, ? extends State>> prev) {
...
// Reduce:
    ...
    public State visitThen(foundation.rpg.common.symbols.Then symbol) throws UnexpectedInputException {
        ...
        return stack3.visitAtomicExpression(getFactory().is(stack2.getNode(), stack1.getNode(), this.getNode())).visitThen(symbol);
    }
