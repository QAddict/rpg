...
public class StateThen2 extends StackState<foundation.rpg.common.symbols.Then, StackState<foundation.rpg.sample.language.ast.Expression, StackState<foundation.rpg.common.symbols.If, ? extends State>>> {

// NoStack:
// Stack:
    public StateThen2(foundation.rpg.sample.language.ast.AstFactory factory, foundation.rpg.common.symbols.Then node, StackState<foundation.rpg.sample.language.ast.Expression, StackState<foundation.rpg.common.symbols.If, ? extends State>> prev) {
...
// Shift:
    ...
    public State visitStatement(foundation.rpg.sample.language.ast.Statement symbol) {
        return new StateStatement4(getFactory(), symbol, this);
    }
