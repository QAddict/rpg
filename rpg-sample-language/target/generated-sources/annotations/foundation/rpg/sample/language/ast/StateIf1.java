...
public class StateIf1 extends StackState<foundation.rpg.common.symbols.If, State> {

// NoStack:
// Stack:
    public StateIf1(foundation.rpg.sample.language.ast.AstFactory factory, foundation.rpg.common.symbols.If node, State prev) {
